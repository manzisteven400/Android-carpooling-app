...
public class PaymentActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initUI();
		initUIInThis();
		setHeaderTitle(R.string.lbl_payment);
	}
...
//					lblPoint.selectAll();
//                    Toast.makeText(PaymentActivity.this, "point not null", Toast.LENGTH_SHORT).show();
//                    return;
//                }
//				
...
//				if(c >=0){
//					
//					Intent i = new Intent(PaymentActivity.this, DetailTransferActivity.class);
